...
更多配置请参考 [RAG配置.md](RAG配置.md)。

## 下一步

### 深入学习
- 阅读 [Agent架构.md](Agent架构.md) 了解 Agent 架构和工具系统
- 阅读 [RAG配置.md](RAG配置.md) 学习 RAG 模式配置
- 阅读 [项目感悟.md](项目感悟.md) 理解 AI 时代的开发反思

### 开发扩展
- 参考 [开发文档.md](开发文档.md) 了解技术实现细节
...
- [Agent架构.md](Agent架构.md) - Agent 功能详解
- [开发文档.md](开发文档.md) - 开发日志
