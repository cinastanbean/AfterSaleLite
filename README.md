...
### 入门指南
- **[快速入门](docs/快速入门.md)** - 5分钟快速启动项目
- **[项目总览](docs/项目总览.md)** - 了解项目整体架构和设计思路

### 技术文档
- **[Agent架构](docs/Agent架构.md)** - Agent 架构详解、API 说明、开发指南
- **[RAG配置](docs/RAG配置.md)** - RAG 模式配置、免费 API 申请
- **[向量数据库](docs/向量数据库.md)** - 向量数据库方案分析、性能评估
- **[实际客服系统](docs/实际客服系统.md)** - 实际客服系统的真实情况分析

### 开发文档
- **[开发文档](docs/开发文档.md)** - 版本历史、技术决策、实现细节

### 项目感悟
- **[项目感悟](docs/项目感悟.md)** - AI 时代的开发反思、角色转变、行业洞察
- **[本意是解决业务问题](docs/本意是解决业务问题.md)** - 回归商业本质，祛魅大模型
...
详细的技术洞察和行业分析请参考 [项目感悟](docs/项目感悟.md)。
