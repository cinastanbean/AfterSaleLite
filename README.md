...
**目前市面上的所谓“客服Agent”，绝大多数确实只能算是大模型增强客服，而不是严格意义上的智能体。两者之间的鸿沟，主要体现在主动性、自主性和工具使用能力这三个维度上。**


**从业务本身反思，你的客服系统需要Agent吗？现有电商的客服系统，基本不需要。**
...
### 入门指南
- **[快速入门](docs/QUICKSTART.md)** - 5分钟快速启动项目
- **[项目总览](docs/PROJECT_OVERVIEW.md)** - 了解项目整体架构和设计思路

### 技术文档
- **[AGENTS.md](docs/AGENTS.md)** - Agent 架构详解、API 说明、开发指南
- **[RAG_SETUP.md](docs/RAG_SETUP.md)** - RAG 模式配置、免费 API 申请
- **[VECTOR_DB.md](docs/VECTOR_DB.md)** - 向量数据库方案分析、性能评估
- **[REAL_WORLD_CUSTOMER_SERVICE.md](docs/REAL_WORLD_CUSTOMER_SERVICE.md)** - 实际客服系统的真实情况分析

### 开发文档
- **[DEVELOPMENT.md](docs/DEVELOPMENT.md)** - 版本历史、技术决策、实现细节

### 项目感悟
- **[INSIGHTS.md](docs/INSIGHTS.md)** - AI 时代的开发反思、角色转变、行业洞察
...
详细配置请参考 [RAG_SETUP.md](docs/RAG_SETUP.md)。
...
完整步骤请参考 [QUICKSTART.md](docs/QUICKSTART.md)。
...
详细的技术洞察和行业分析请参考 [INSIGHTS.md](docs/INSIGHTS.md)。
